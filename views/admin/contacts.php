...
<head>
    ...
    <style>
        ...
        .sidebar { width: 220px; background: #111827; color: white; padding-top: 20px; }
        .sidebar h3 { font-weight: bold; padding: 0 18px; margin-bottom: 30px; }
        .sidebar a { display: block; color: white; text-decoration: none; padding: 14px 18px; font-weight: bold; }
        .sidebar a:hover, .sidebar a.active { background: #1f2937; }
        .content { flex: 1; padding: 28px; }
        .box { background: white; border-radius: 10px; padding: 25px; box-shadow: 0 3px 12px rgba(0,0,0,.08); }
...
<div class="admin-layout">
    ...
    <div class="sidebar">
        ...
        <a href="<?= BASE_URL ?>?act=admin-contacts" class="active">Quản lý liên hệ</a>
    ...
    <div class="content">
        <div class="box">
            ...
            <h2 class="mb-4 fw-bold">Quản lý liên hệ</h2>
                ...
                <tbody>
                    ...
                    <?php foreach ($contacts as $item): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= BASE_URL ?>?act=admin-contact-delete&id=<?= $item['id'] ?>"
